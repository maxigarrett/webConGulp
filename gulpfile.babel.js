...
gulp.task("babel", () => {
  return gulp
    ...
    .pipe(plumber())
    .pipe(
      babel({ presets: [ "@babel/preset-env" ] })//es un ajuste preestablecido inteligente que le permite utilizar el último JavaScript sin necesidad de microgestión de las transformaciones de sintaxis
    )
